...
const UpdateProduct = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Fix 1: Always send the 'image' state, or an empty file blob to prevent "null" string
    if (image) {
      updatedProduct.append("imageFile", image);
    } else {
      updatedProduct.append("imageFile", new Blob([]), "empty.jpg");
    }
    
    // Fix 2: Convert strings back to real numbers for the backend
